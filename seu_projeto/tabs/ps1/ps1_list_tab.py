"""
PS1 List Tab — PRO HYBRID

✔ Layout idêntico ao PS2
✔ Tema dark
✔ Checkboxes em todas listas
✔ Source → Queue → Drive
✔ Híbrido seguro
✔ Standalone seguro
"""
...
class PS1ListTab:
    ...
    def __init__(self, parent, services=None):
        ...
        # compatibilidade com seu container
    ...
    def refresh_drive(self):
        ...
        for jogo in jogos:
            ...
            self.tree_drive.insert("", "end",
                                   values=(self.CHECK_OFF, nome))
    ...
    def add_selected_to_queue(self):
        for item in self.tree_source.get_children():
            if self.tree_source.item(item, "values")[0] == self.CHECK_ON:
                ...
                self.tree_queue.insert("", "end",
                                       values=(self.CHECK_OFF, name))
